import com.cxl.redis.RedisLock;
...
public class xxx {
     ...
     */
         ...
         */
        public xxx(RedisTemplate redisTemplate, String lockKey) {
         ...
         */
        public xxx(RedisTemplate redisTemplate, String lockKey, int expireTime) {
         ...
         */
        public xxx(RedisTemplate redisTemplate, String lockKey, long timeout) {
            this(redisTemplate, lockKey);
            this.timeout = timeout;
        }
         ...
         * @param timeout       请求锁的超时时间(单位：毫秒)
         */
        public xxx(RedisTemplate redisTemplate, String lockKey, int expireTime, long timeout) {
    ...
    public static void main(String[] args) {
        xxx xxx = new xxx(new RedisTemplate(), "RedisLockKey", 10, 500L);
        try {
            // 获得锁
            if (xxx.lock()) {
                // 业务逻辑
