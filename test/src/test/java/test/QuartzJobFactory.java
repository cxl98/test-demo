//package test;
//
//import com.asiainfo.power.basedate.quartz.entity.QuartzJobEntity;
//import com.asiainfo.power.basedate.quartz.service.interfaces.IQuartzJobService;
//import com.asiainfo.power.utiltools.config.Global;
//import com.asiainfo.power.utiltools.utils.*;
...
//    private static final String CONFIG_NAME = "quartz-server.properties";
...
//        log.info("加入定时参数："+"jobId:"+jobId+",jobName:"+jobName+",triggerName:"+triggerName+",cronExpression:"+cronExpression+",jobState:"+jobState+",jobClazz:"+jobClazz);
//        if (scheduler == null) {
...
//        /**
//         * 修改，如果进程已经启动，无需启动，如果未启动进行启动
//         */
//        if(!scheduler.isStarted()){
//            Date data = scheduler.scheduleJob(jobDetail, trigger);
//            log.info("定时器启动时间------------------------------------>>>："+DateUtils.formatDate(data));
//        }
//    }
//
//    /**
...
//     * @param jobEntity
//     */
//    public static void addJob(QuartzJobEntity jobEntity) throws Exception {
//        if (scheduler == null) {
//            StdSchedulerFactory factory = new StdSchedulerFactory(CONFIG_NAME);
//            scheduler = factory.getScheduler();
//        }
...
//        log.info("开始加载待处理任务");
//        IQuartzJobService quartzJobServiceImpl = SpringContextHolder.getBean(IQuartzJobService.class);
//        List<QuartzJobEntity> quartzJobEntityList = quartzJobServiceImpl.getAllCfgQuartzJob();
//
...
//
//            for (QuartzJobEntity jobEntity : quartzJobEntityList) {
//                System.out.println("待处理任务数量--------------------------------------->"+quartzJobEntityList.size());
...
//     * 判断该JOB是否可以由改模块进行处理
//     */
//    private static boolean canDealJob(QuartzJobEntity jobEntity, List<Map> redisQuartzLists) {
...
//     * @throws Exception
//     */
//    private static JobDetail addJobDetail(QuartzJobEntity jobEntity) throws Exception {
